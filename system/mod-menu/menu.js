...
function openClientNatureSubMenu(type) {
    ...
    if (type === "Contribuyente") {
        options = `
        <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-ctb-ntl/ctb-ntl.html'">Natural</button>
        <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-ctb-jrc/ctb-jrc.html'">Jurídico</button>
    `;
    } else if (type === "Sujeto Excluido") {
        options = `
            <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-sjx-ntl/sjx-ntl.html'">Natural</button>
            <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-sjx-jrc/sjx-jrc.html'">Jurídico</button>
            <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-sjx-ong/sjx-ong.html'">ONG</button>
            <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-sjx-instituto/sjx-instituto.html'">Instituciones del Gobierno</button>
         <button class="client-type-button" onclick="window.location.href='../mod-cliente/form-sjx-instituto-NX/sjx-instituto-NX.html'">Instituciones del Gobierno (NO EXENTAS)</button>
        `;
    }
